...
bool Graphics::Render()
{
	...
	_lightShader->Render(_driver->GetD3D11DeviceContext(), _mesh->GetIndexCount(), worldMatrix, viewMatrix, projectionMatrix, _mesh->GetTextureView(),
		_dirLight, _camera->GetPosition());
