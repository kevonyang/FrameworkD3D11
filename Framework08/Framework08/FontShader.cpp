...
FontShader::FontShader(FontShader&)
{
}
...
{
	if (!InitializeShader(device, hWnd, "FontShader.vs", "FontShader.ps"))
		return false;
	return true;
}
...
bool FontShader::InitializeShader(ID3D11Device  *device, HWND hWnd, char *vsFileName, char *psFileName)
{
...
void FontShader::ShowErrorMessage(HWND hWnd, ID3DBlob *errBlob, char *fileName)
{
...
void FontShader::Render(ID3D11DeviceContext *deviceContext, UInt32 indexCount, DirectX::CXMMATRIX worldMatrix, DirectX::CXMMATRIX viewMatrix, DirectX::CXMMATRIX projectionMatrix, ID3D11ShaderResourceView *textureView)
{
	SetShaderParameters(deviceContext, worldMatrix, viewMatrix, projectionMatrix, textureView);
	RenderShader(deviceContext, indexCount);
}

bool FontShader::SetShaderParameters(ID3D11DeviceContext *deviceContext, DirectX::CXMMATRIX worldMatrix, DirectX::CXMMATRIX viewMatrix, DirectX::CXMMATRIX projectionMatrix, ID3D11ShaderResourceView *textureView)
{
...
void FontShader::RenderShader(ID3D11DeviceContext *deviceContext, UInt32 indexCount)
{
