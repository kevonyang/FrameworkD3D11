...
{
	if (!InitializeShader(device, hWnd, "TextureShader.vs", "TextureShader.ps"))
		return false;
	return true;
}

bool TextureShader::InitializeShader(ID3D11Device *device, HWND hWnd, char *vsFileName, char *psFileName)
{
...
void TextureShader::ShowErrorMessage(HWND hWnd, ID3DBlob *errBlob, char *fileName)
{
...
void TextureShader::Render(ID3D11DeviceContext *deviceContext, UInt32 indexCount, DirectX::CXMMATRIX worldMatrix, DirectX::CXMMATRIX viewMatrix, DirectX::CXMMATRIX projectionMatrix, ID3D11ShaderResourceView *textureView)
{
	SetShaderParameters(deviceContext, worldMatrix, viewMatrix, projectionMatrix, textureView);
	RenderShader(deviceContext, indexCount);
}

bool TextureShader::SetShaderParameters(ID3D11DeviceContext *deviceContext, DirectX::CXMMATRIX worldMatrix, DirectX::CXMMATRIX viewMatrix, DirectX::CXMMATRIX projectionMatrix, ID3D11ShaderResourceView *textureView)
{
...
void TextureShader::RenderShader(ID3D11DeviceContext *deviceContext, UInt32 indexCount)
{
