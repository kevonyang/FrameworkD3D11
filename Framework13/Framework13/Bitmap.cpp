...
bool Bitmap::Initialize(ID3D11Device *device, char *texFileName1, char *texFileName2, int width, int height)
{
	_width = width;
	_height = height;
	...
	if (!_textureArray->Initialize(device, texFileName1, texFileName2))
		return false;
